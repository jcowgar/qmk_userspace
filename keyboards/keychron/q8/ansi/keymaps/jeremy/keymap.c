...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_69(
        ...
        KC_LCTL, KC_LOPT,  KC_LCMD,           JC_NSP,           MO(_NAV), MO(_SYM),         JC_SET,            KC_RCMD,            KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [WIN_BASE] = LAYOUT_ansi_69(
        ...
        CW_TOGG, JC_A,     JC_R,     JC_S,    JC_T,    KC_G,              KC_M,    JC_N,    JC_E,    JC_I,     JC_O,     KC_SCLN,  KC_ENT,           KC_PGDN,
        KC_LSFT,           KC_Z,     KC_X,    KC_C,    KC_D,    KC_V,     KC_UNDS, KC_K,    KC_H,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, KC_UP,
        KC_LCTL, KC_LWIN,  KC_LALT,           KC_SPC,           MO(_NAV), MO(_SYM),         JC_SET,            KC_RALT,            KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_NUM] = LAYOUT_ansi_69(
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,           _______,
        _______, KC_MINS, KC_7,    KC_8,    KC_9,    _______, _______, _______, _______, _______, QK_BOOT, _______, _______, _______,          _______,
        _______, KC_PLUS, KC_4,    KC_5,    KC_6,    KC_ASTR,          KC_EQL,  KC_DLR,  KC_HASH, KC_PERC, _______, _______, _______,          _______,
        _______, KC_0,    KC_1,    KC_2,    KC_3,    KC_SLSH, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______,          _______,          _______, _______,          _______,          _______,           _______, _______, _______),
